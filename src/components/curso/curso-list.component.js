...
export default class CursoList extends Component {
  ...
  render() {
    const { searchTitulo, cursos, currentCurso, currentIndex, currentUser, showUserBoard, showModeratorBoard, showTeacherBoard } = this.state;
        ...
        <header className="jumbotron">
          ...
          { currentUser && (
            ...
            <div>
              <Jumbotron fluid="md">
                <Container >
                  <h1 class="display-5">Que pasaaaaaaa</h1>
                </Container>
              </Jumbotron>
